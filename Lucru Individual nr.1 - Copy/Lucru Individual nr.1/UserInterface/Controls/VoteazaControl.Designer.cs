namespace MelodiiApp.UserInterface.Controls
{
    partial class VoteazaControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.colPuncteAlocate.DefaultCellStyle = dataGridViewCellStyle2;
            this.colPuncteAlocate.HeaderText = "Puncte (0-6)";
            this.colPuncteAlocate.MaxInputLength = 1;
            this.colPuncteAlocate.MinimumWidth = 6;
            this.colPuncteAlocate.Name = "colPuncteAlocate";
            this.colPuncteAlocate.ToolTipText = "Introduceți un număr între 0 și 6. Totalul alocat nu poate depăși 6.";
            this.colPuncteAlocate.Width = 80;
            // 
