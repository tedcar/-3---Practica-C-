...
namespace MelodiiApp.UserInterface.Controls
{
    ...
    public partial class GestioneazaIntervievatiControl : UserControl
    {
        ...
        /// <summary>
        /// Eveniment declanșat după ce datele intervievaților (ștergere, modificare) au fost actualizate.
        /// </summary>
        public event EventHandler IntervievatDataChanged;
        ...
        private void EditSelectedIntervievat()
        {
            ...
            using (var frm = new EditIntervievatForm(interv))
            {
                ...
                {
                    RefreshData();
                    IntervievatDataChanged?.Invoke(this, EventArgs.Empty); // Notify MainForm
