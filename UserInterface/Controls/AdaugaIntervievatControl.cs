...
namespace MelodiiApp.UserInterface.Controls
{
    ...
    public partial class AdaugaIntervievatControl : UserControl
    {
        ...
        /// <summary>
        /// Eveniment declanșat după ce un intervievat a fost salvat cu succes.
        /// </summary>
        public event EventHandler IntervievatSaved;
        ...
        {
            ClearStatusLabel();
            ThemeHelper.StyleSpecificLabel(lblStatus, ThemeHelper.TextColorOnDark);
            ...
            if (success)
            {
                ...
                IntervievatSaved?.Invoke(this, EventArgs.Empty);
